    ...
    <React.Fragment>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-12">
              ...
              <React.Fragment>
                <div className="flex justify-between border-b pb-8">
                  ...
                  <h2 className="font-semibold text-2xl">
                    {props.cart && props.cart.total_items} Items
                  </h2>
                </div>
        ...
        "
                ...
                {props.cart &&
                  props.cart.cart_items &&
                  props.cart.cart_items.length > 0 &&
          ...
          >
            ...
            <div className="flex justify-between mt-10 mb-5">
              <span className="font-semibold text-sm uppercase">
                Items {props.cart && props.cart.total_items}
              </span>
              <span className="font-semibold text-sm">
                {props.cart && props.cart.total_price}$
              </span>
            </div>
            <div className="py-10">
              <label
            ...
            <div className="border-t mt-8">
              <div className="flex font-semibold justify-between py-6 text-sm uppercase">
                ...
                <span>${props.cart && props.cart.total_price}</span>
              </div>
              {props.cart && (
                <form
                ...
                >
                  <input
                    type="hidden"
                    name="business"
                    value="sb-cjjnm2583485@business.example.com"
                  />
                  <input
                    type="hidden"
                    name="image_url"
                    value="https://www.paypalobjects.com/webstatic/en_US/i/buttons/checkout-logo-large.png"
                  />
                  ...
                  <input
                    type="hidden"
                    name="amount"
                    value={props.cart.total_price}
                  />
                  <input type="hidden" name="currency_code" value="USD" />
                  <input type="hidden" name="cmd" value="_xclick" />
                  <input type="hidden" name="no_note" value="1" />
                  <input type="hidden" name="no_shipping" value="1" />
                  <input type="hidden" name="return" value={callbackUrl} />
